...
// hide dupicate cards
carouselSeller.classList.add("no-transition");
carouselSeller.scrollLeft = carouselSeller.offsetWidth;
carouselSeller.classList.remove("no-transition");
...
// hide dupicate cards
carouselCategory.classList.add("no-transition");
carouselCategory.scrollLeft = carouselCategory.offsetWidth;
carouselCategory.classList.remove("no-transition");
