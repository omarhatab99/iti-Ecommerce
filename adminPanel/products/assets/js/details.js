...
const displayTargetProduct = async() => {
    ...
    for (let index = 0; index < 5; index++) {
        ...
        if(numOfStars != 0) {
            stars += `<img src="assets/images/Filled_star.png" class="raiting" alt="raiting" data-index = ${index}>`;
            numOfStars--;
        }
        else
        {
            stars += `<img src="assets/images/empty_star.png" class="raiting" alt="raiting" data-index = ${index}>`;
        }
    };
