...
$(function() {
    ...
    var dt_basic_table = $(".datatables-reviews-basic");
    ...
    if (dt_basic_table.length) {
        ...
        columns: [
            ...
            { data: 'RatingValue' , name: "ratingValue"},
            { data: '' }
        ],
        ...
        columnDefs: [
                ...
                
                {
                    ...
                    return `
                        ...
                        <a class="display-message js-show-message" data-id=${full["id"]}> 
                            ${!full["Watched"] ? `<i class="fa-regular fa-eye-slash js-show-message" data-id=${full["id"]} ></i>` : `<i class="fa-solid fa-eye js-show-message" data-id=${full["id"]}></i>`}
                        </a>
